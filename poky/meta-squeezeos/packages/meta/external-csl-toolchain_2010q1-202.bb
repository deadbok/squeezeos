...
SRC_URI = "https://sourcery.mentor.com/public/gnu_toolchain/arm-none-linux-gnueabi/arm-${PV}-arm-none-linux-gnueabi-i686-pc-linux-gnu.tar.bz2 \
	file://SUPPORTED"


do_unpack2() {
	mkdir -p ${CROSS_DIR}
	cp -r ${WORKDIR}/arm-2010q1/arm-none-linux-gnueabi ${CROSS_DIR}
	cp -r ${WORKDIR}/arm-2010q1/bin ${CROSS_DIR}
	cp -r ${WORKDIR}/arm-2010q1/lib ${CROSS_DIR}
	cp -r ${WORKDIR}/arm-2010q1/libexec ${CROSS_DIR}
	cp -r ${WORKDIR}/arm-2010q1/share ${CROSS_DIR}
}
...
do_install() {
	...
	cp -a ${CROSS_DIR}/arm-none-linux-gnueabi/libc/lib/*  ${D}${base_libdir}
...
do_stage() {
	...
	cp -a ${CROSS_DIR}/arm-none-linux-gnueabi/libc/usr/include/* ${STAGING_INCDIR}

	install -d ${STAGING_LIBDIR}
	cp -a ${CROSS_DIR}/arm-none-linux-gnueabi/libc/usr/lib/* ${STAGING_LIBDIR}

	install -d ${STAGING_DIR_TARGET}${layout_base_libdir}
	cp -a ${CROSS_DIR}/arm-none-linux-gnueabi/libc/lib/* ${STAGING_DIR_TARGET}${base_libdir}
